...
public class Simulation
{
	public Simulation()
	{
		Router r = new Router("ROUTER1","dasPW");
		Attacker a = new Attacker(r,120);
		Computer c1 = new Computer(r,"Computer1","dasPW",false);
		...
		Computer c6 = new Computer(r,"Computer6","dasPW",false);
